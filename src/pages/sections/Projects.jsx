...
const Projects = () => {
    ...
    return (
        <div>
            ...
            >
                Check out all the projects I have done from hackathons, personal
                ventures and school!
            </div>
            <div
                style={{ animationPlayState: "paused" }}
                className="flex justify-center items-center animate animate-fade-up animate-once animate-duration-[1500ms]"
            >
                <div className="carousel carousel-center max-w-5xl p-4 space-x-4 rounded-box mx-[60px] mb-[200px]">
                    <div
                        className="carousel-item hover:scale-105 transition duration-300 ease-in-out cursor-pointer mx-3"
                        onClick={() =>
                            document.getElementById("openjio").showModal()
                        }
                    >
                                ...
                                <div className="m-2">
                                    <div className="flex flex-row justify-center items-center">
                                        ...
                                        <div className="basis-1/2">
                                            ...
                                            <div>
                                                OpenJio is a web application
                                                designed to streamline event
                                                registration at SMU, replacing
                                                traditional methods like Google
                                                Forms. It increases the
                                                visibility of school activities
                                                around campus. The platform also
                                                features an algorithm to select
                                                participants based on their
                                                attendance history, enhancing
                                            ...
                                            <div>
                                                ...
                                                Jacoco, Mockito, Postman
                                            </div>
                                            <div>
                                                Deployment + CI/CD: Github
                                                Actions, Docker, Docker Compose,
                                                AWS, SonarCloud
                                            </div>
                                            <br></br>
                                            <ul className="list-disc ml-[10px]">
                                                <li>
                                                    Orchestrated DevOps and
                                                ...
                                                <li>
                                                    ...
                                                    Tailwind CSS and other UI
                                                    libraries
                                                </li>
                                                <li>
                                                    Constructed a robust
                                                    infrastructure with Docker,
                                                    ECS, RDS, S3, Fargate, ALB
                                                    and Route53
                                                </li>
                                                <li>
                                                    Automated 3 workflows with
                                                    GitHub Actions, integrating
                                                    code quality analysis with
                                                    SonarCloud and testing with
                                                    Docker Compose
                                                </li>
                                            </ul>
                                        </div>
                    ...
                    <div
                        className="carousel-item hover:scale-105 transition duration-300 ease-in-out cursor-pointer mx-3"
                        onClick={() =>
                            document.getElementById("unicents").showModal()
                        }
                    >
                        <div className="card w-96 bg-base-100 shadow-xl">
                            <figure>
                            ...
                            <div className="card-body">
                                ...
                                <p className="mb-[10px]">
                                    A web application to address financial
                                    hardships addressed by university students,
                                    particularly those from underprivileged
                                    backgrounds
                                </p>
                                <div className="card-actions justify-end">
                                    <div className="badge badge-outline">
                                ...
                                <div className="m-2">
                                    <div className="flex flex-row justify-center items-center">
                                        ...
                                        <div className="basis-1/2">
                                            ...
                                            <div>
                                                Recognising the challenges in
                                                accessing and comparing
                                                university costs, our solution
                                                is a user-centric application to
                                                mitigate real consequences faced
                                                by peers who are compelled to
                                                abandon studies or prioritize
                                                part-time work due to inadequate
                                                financial planning.
                                            </div>
                                            <br></br>
                                            <div className="underline mb-[10px]">
                                            ...
                                            <ul className="list-disc ml-[10px]">
                                                <li>
                                                    University Comparator to
                                                    compare costs across
                                                    universities and understand
                                                    available financial
                                                    assistance schemes tailored
                                                    to each user's eligibility
                                                    criteria
                                                </li>
                                                <li>
                                                    Donor Matching Platform to
                                                ...
                                                <li>
                                                    Discussion Forums to connect
                                                    with like-minded individuals
                                                    & share tips to be money
                                                    smart
                                                </li>
                                            </ul>
                                        </div>
